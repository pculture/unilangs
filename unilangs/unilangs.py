...
def _generate_initial_data():
    INTERNAL_NAMES.update({
        ...
        'ak': (gettext_noop(u'Akan'), u'Akana'),
        'am': (gettext_noop(u'Amharic'), u'Amharic'),
        ...
        'bm': (gettext_noop(u'Bambara'), u'Bamanankan'),
        ...
        'ha': (gettext_noop(u'Hausa'), u'هَوُسَ'),
        ...
        'kr': (gettext_noop(u'Kanuri'), u'Kanuri'),
        'ki': (gettext_noop(u'Gikuyu'), u'Gikuyu'),
        'rw': (gettext_noop(u'Rwandi'), u'Kinyarwanda'),
        ...
        'kg': (gettext_noop(u'Kongo'), u'Kongo'),
        ...
        'ln': (gettext_noop(u'Lingala'), u'Lingala'),
        ...
        'mg': (gettext_noop(u'Malagasy'), u'Malagasy'),
        ...
        'ny': (gettext_noop(u'Chewa'), u'Chewa'),
        'oc': (gettext_noop(u'Occitan'), u'Occitan'),
        'oj': (gettext_noop(u'Ojibwe'), u'Ojibwe'),
        'or': (gettext_noop(u'Oriya'), u'Oriya'),
        'om': (gettext_noop(u'Oromo'), u'Oromoo'),
        ...
        'pa': (gettext_noop(u'Eastern Punjabi'), u'ਪੰਜਾਬੀ'),
        ...
        'qu': (gettext_noop(u'Quechua'), u'Runa Simi'),
        ...
        'rn': (gettext_noop(u'Rundi'), u'Kirndi'),
        ...
        'so': (gettext_noop(u'Somali'), u'Soomaaliga'),
        'st': (gettext_noop(u'Sotho'), u'seSotho'),
        ...
        'sw': (gettext_noop(u'Swahili'), u'Kiswahili'),
        ...
        'ti': (gettext_noop(u'Tigrinya'), u'Tigrinya'),
        ...
        'tn': (gettext_noop(u'Tswana'), u'Setswana'),
        ...
        'wo': (gettext_noop(u'Wolof'), u'Wollof'),
        'xh': (gettext_noop(u'Xhosa'), u'isiXhosa'),
        'yi': (gettext_noop(u'Yiddish'), u'ייִדיש'),
        'yo': (gettext_noop(u'Yoruba'), u'Yorùbá'),
        ...
        'zu': (gettext_noop(u'Zulu'), u'isiZulu'),
    })
